...
def example_horizontal_reduction():
    ...
    prov.print_result(df1, df1_horizontal_reduced, result)
...
def example_horizontal_augmentation():
    ...
    prov.print_result(df1, df_horizontal_augmented, result)
...
def example_vertical_reduction():
    ...
    prov.print_result(df1, df1_vertical_reduced, result)
...
def example_vertical_augmentation():
    ...
    prov.print_result(df1, df1_vertical_augmented, result)
...
def example_data_transformation():
    ...
    prov.print_result(df1, df1_transformed, result)
